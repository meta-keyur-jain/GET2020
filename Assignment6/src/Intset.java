...
final public class Intset {
    ...
    /**
     * This is the method to initilize the array and it is basically constructor
     * of class Inset. It take number in range of 1-1000.
     * 
     * @param arr
    ...
    public boolean is_subset(int arr[]) {
