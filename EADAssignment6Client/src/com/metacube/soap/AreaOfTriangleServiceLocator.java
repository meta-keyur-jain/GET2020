...
public class AreaOfTriangleServiceLocator extends org.apache.axis.client.Service implements com.metacube.soap.AreaOfTriangleService {
    ...
    private java.lang.String AreaOfTriangle_address = "http://localhost:8080/EADAssignment6/services/AreaOfTriangle";
    ...
    public com.metacube.soap.AreaOfTriangle getAreaOfTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.soap.AreaOfTriangle getAreaOfTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.soap.AreaOfTriangleSoapBindingStub _stub = new com.metacube.soap.AreaOfTriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.soap.AreaOfTriangle.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.soap.AreaOfTriangleSoapBindingStub _stub = new com.metacube.soap.AreaOfTriangleSoapBindingStub(new java.net.URL(AreaOfTriangle_address), this);
                _stub.setPortName(getAreaOfTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap.metacube.com", "AreaOfTriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap.metacube.com", "AreaOfTriangle"));
        }
