...
<jsp:useBean id="sampleAreaOfTriangleProxyid" scope="session" class="com.metacube.soap.AreaOfTriangleProxy" />
<%
...
case 10:
        gotMethod = true;
        com.metacube.soap.AreaOfTriangle getAreaOfTriangle10mtemp = sampleAreaOfTriangleProxyid.getAreaOfTriangle();
...
case 13:
        ...
        double calculate13mtemp = sampleAreaOfTriangleProxyid.calculate(side1_1idTemp,side2_2idTemp,side3_3idTemp);
