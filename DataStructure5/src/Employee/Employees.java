...
public static void main(String[] args) {
    ...
    e.insertIntoEmployee("keyur", 5, 21);
    e.insertIntoEmployee("keyur", 15, 22);
    e.insertIntoEmployee("keyur", 2, 10);
    e.insertIntoEmployee("keyur", 2, 20);
    e.insertIntoEmployee("keyur", 1, 25);
    e.insertionSort();
    e.printList();
