...
public class DictionaryImplementation {
    ...
    public static void main(String[] args) {
        ...
        Node n1 = new Node(8, "keyur");
        d.insertKey(n1);
        Node n2 = new Node(3, "jain");
        d.insertKey(n2);
        Node n3 = new Node(10, "kunal");
        d.insertKey(n3);
        Node n4 = new Node(1, "kaushik");
        d.insertKey(n4);
        Node n5 = new Node(6, "harshit");
        d.insertKey(n5);
        Node n6 = new Node(14, "singla");
        d.insertKey(n6);
        Node n7 = new Node(4, "rahul");
        d.insertKey(n7);
        Node n8 = new Node(7, "kumar");
        d.insertKey(n8);
        Node n9 = new Node(13, "gopal");
        d.insertKey(n9);
        // d.show();
        d.print2D(n1, 0);
        d.deleteKey(3);
