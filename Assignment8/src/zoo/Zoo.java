...
public class Zoo {
    ...
    /**
     * This HashMap contain details about all zones that added to the zoo here
     * key is the integer key numberOfZones which start with 0 and increases as
     * more zones are added and value is the zone object zone can't be removed
     * once created
     */
     ...
     * 
     * @param zone
     *            object of the Zone Class containing details about the zone
    ...
    /**
     * 
     * This method find suitable zone for the animal according to animal
     * category and sub category
     * 
     * @param animal
     *            object of animal containing details about animal
     * @return object of Zone Class containing suitable zone for the given
     *         animal
     * @throws Exception
     *             if no suitable zone found for the type of the animal
     */
    private static Zone findSupportedZoneForAnimal(Animal animal)
            throws Exception {
        /**
         * checking every zone that is available in the zoo
         */
        for (Zone zone : Zoo.zonesInZoo.values()) {
            if (zone.categoryOfAnimalSupported
                    .equalsIgnoreCase(animal.category)
                    && zone.subcategoryOfAnimalSupported
                            .equalsIgnoreCase(animal.subCategory)) {
                return zone;
            }
        }
        /**
     ...
     * 
     * @param animal
     *            object of animal representing any animal and contain its
     *            details
     * @return true if the animal added successfully else false
     * @throws Exception
     *             if animal is not added
     */
    static boolean adanimal = false;
     ...
     * 
     * @param cage
     *            object of the Cage Class containing details about the cage
     *            that need to be added
     * @return true if cage added successfully else false
     * @throws Exception
     *             if cage is not added
     */
    static boolean adCage = false;
     ...
     * 
     * @param animal
     *            object of the animal class containing details about the animal
     *            that needed to be removed
     * @return true if the animal removed successfully else false
     * @throws Exception
     *             if the animal can't be removed
     */
    static boolean remAnimal = false;
